...
const ChangePassword = ({close}) => {
    ...
    const passwordControl = (password, regex) => {
    ...
    const sendNewPassword = (e) => {
        e.preventDefault()
        // Ne pas oublier d'ajouter les matchs
        ...
        <div className='modifyPassword'>
            <form className='modifyPassword--form' onSubmit={sendNewPassword} >
                ...
                { // Affichage d'erreur si le mot de passe ne match pas avec la regex
                    actualPassword.length > 1 && !passwordControl(actualPassword, passwordReg) &&
                ...
                { // Affichage d'erreur si le mot de passe ne match pas avec la regex
                    newPassword.length > 1 && !passwordControl(newPassword, passwordReg) &&
                    <p className='modifyPassword--form__err'>
                        <i className="fa-solid fa-triangle-exclamation"></i>
                        Mot de passe incorrect
                    </p>
